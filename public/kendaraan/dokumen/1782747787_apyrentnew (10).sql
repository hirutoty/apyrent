...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 22 Jun 2026 pada 07.15
...
(5, 1, 2, 1, 'aktif', '2026-06-20', '2026-12-20', 6, 20000.00, 'asuransi/bukti_bayar/1781967324_service-history (3).pdf', '2026-06-13 12:28:57', '2026-06-20 07:55:24');
...
(1, NULL, '2026-06-01', 'PPh21', '01.234.567.8-901.000', 'PT Rental Maju Jaya', '09.876.543.2-109.000', 'Budi Santoso', 5000000.00, 0.05, 2500.00, 'Approve', 'bupot/1781967661_data-rental (7).pdf', '2026-06-10 20:04:04', '2026-06-20 08:01:01'),
...
--
-- Struktur dari tabel `detail_unit_kendaraans`
--

CREATE TABLE `detail_unit_kendaraans` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `penawaran_kendaraan_id` bigint(20) UNSIGNED NOT NULL,
  `tipe_kendaraan` varchar(255) NOT NULL,
  `qty` int(10) UNSIGNED NOT NULL DEFAULT 1,
  `warna` varchar(255) DEFAULT NULL,
  `nopol_keterangan` text DEFAULT NULL,
  `durasi_bulan` int(10) UNSIGNED DEFAULT NULL,
  `tahun` smallint(5) UNSIGNED DEFAULT NULL,
  `harga_sewa_bulan` decimal(15,2) NOT NULL DEFAULT 0.00,
...
--
-- Dumping data untuk tabel `detail_unit_kendaraans`
--

INSERT INTO `detail_unit_kendaraans` (`id`, `penawaran_kendaraan_id`, `tipe_kendaraan`, `qty`, `warna`, `nopol_keterangan`, `durasi_bulan`, `tahun`, `harga_sewa_bulan`, `status`, `status_note`, `created_at`, `updated_at`) VALUES
(1, 1, 'toyota avansa', 1, 'item', 'Ganjil', 2, 2026, 200000.00, 'On Progress', NULL, '2026-06-21 12:04:57', '2026-06-21 12:04:57'),
(2, 1, 'Alphard', 2, 'Putih', 'Genep', 4, 2025, 400000.00, 'On Progress', NULL, '2026-06-21 12:04:57', '2026-06-21 12:04:57');
...
(2, 2, 2, 'TK103', 'aktif', '2025-08-11', '2026-08-11', 120000, 12, 'aktif', 'gps/bukti_bayar/1781967370_data-rental (4).pdf', '2026-06-10 20:04:03', '2026-06-20 07:56:10'),
...
CREATE TABLE `invoices` (
  ...
  `per_month` decimal(15,2) NOT NULL DEFAULT 0.00,
...
INSERT INTO `invoices` (`id`, `customer_name`, `address`, `contact_person`, `phone`, `start_date`, `end_date`, `remarks`, `qty`, `per_month`, `subtotal`, `ppn`, `total`, `signature`, `created_at`, `updated_at`) VALUES
(2, 'hiru', 'alamdfdadffdf,  dfafdjfdff,dfdffffffffffff', 'hiru', '000303', '2026-06-22', '2026-07-22', 'Sewa Mobil Sejam22', 2, 10000.00, 20000.00, 2200.00, 22200.00, 'signature/1782062645_b0cc7cb2-5af9-4898-930c-96aa9c3dbfbf.jpg', '2026-06-21 10:18:01', '2026-06-21 10:49:22');
...
(1, 1, 1, 'AA 1234 ZX', NULL, 'Budi Santoso', 'Wonosobo', 'Toyota Avanza', '2021', '2021', '1500 CC', 'Hitam', 'MHKS12345678901', 'ENG123456', 'BPKB001122', 'Hitam', 'Pertalite', 'AA', '123456', 350000, 50000, 1000000, NULL, '2027-06-11', 45000, 5000, 6, 40000, '2026-04-11', 'aman', 'disewa', '2026-06-10 20:04:03', '2026-06-21 21:07:47'),
(2, 1, 2, 'AA 5678 YY', 'kendaraan/foto/1781399355_ChatGPT Image 31 Mei 2026, 21.18.42.png', 'Joko Widodo', 'Magelang', 'Honda Brio', '2020', '2020', '1200 CC', 'Merah', 'MHKS987654321', 'ENG998877', 'BPKB9988', 'Hitam', 'Pertamax', 'AA', '654321', 300000, 45000, 900000, 'kendaraan/dokumen/1781397755_data-rental (9).pdf', NULL, 60000, 5000, 6, 55000, NULL, 'service', 'tersedia', '2026-06-10 20:04:03', '2026-06-21 20:47:28'),
...
(51, '2026-06-20', 'STNK-1', 1, 'stnk_kendaraan', 'cash', 'Perpanjangan STNK kendaraan: AA 1234 ZX - Toyota Avanza', 0.00, 10000.00, 12531997.00, '2026-06-20 11:54:39', '2026-06-20 11:54:39'),
(52, '2026-06-21', 'STNK-2', 1, 'stnk_kendaraan', 'cash', 'Perpanjangan STNK kendaraan: AA 1234 ZX - Toyota Avanza', 0.00, 10000.00, 12521997.00, '2026-06-21 08:48:13', '2026-06-21 08:48:13'),
(53, '2026-06-22', 'PAY-13-034938571', 1, 'Pemasukan', 'auto', 'Rental Honda Brio - AA 5678 YY', 3600000.00, 0.00, 16121997.00, '2026-06-21 20:49:38', '2026-06-21 20:49:38'),
(54, '2026-06-22', 'PAY-13-034943827', 1, 'Pemasukan', 'auto', 'Rental Honda Brio - AA 5678 YY', 3600000.00, 0.00, 19721997.00, '2026-06-21 20:49:43', '2026-06-21 20:49:43'),
(55, '2026-06-22', 'PAY-13-034959445', 1, 'Pemasukan', 'auto', 'Rental Honda Brio - AA 5678 YY', 3600000.00, 0.00, 23321997.00, '2026-06-21 20:49:59', '2026-06-21 20:49:59'),
(56, '2026-06-22', 'PAY-14-035058351', 1, 'Pemasukan', 'auto', 'Rental Toyota Avanza - AA 1234 ZX', 126000000.00, 0.00, 149321997.00, '2026-06-21 20:50:58', '2026-06-21 20:50:58'),
(57, '2026-06-22', 'PAY-14-035105820', 1, 'Pemasukan', 'auto', 'Rental Toyota Avanza - AA 1234 ZX', 126000000.00, 0.00, 275321997.00, '2026-06-21 20:51:05', '2026-06-21 20:51:05'),
(58, '2026-06-22', 'PAY-14-035240725', 1, 'Pemasukan', 'auto', 'Rental Toyota Avanza - AA 1234 ZX', 126000000.00, 0.00, 401321997.00, '2026-06-21 20:52:40', '2026-06-21 20:52:40'),
(59, '2026-06-22', 'PAY-13-035632721', 1, 'Pemasukan', 'auto', 'Rental Honda Brio - AA 5678 YY', 3600000.00, 0.00, 404921997.00, '2026-06-21 20:56:32', '2026-06-21 20:56:32'),
(60, '2026-06-22', 'PAY-13-035634910', 1, 'Pemasukan', 'auto', 'Rental Honda Brio - AA 5678 YY', 3600000.00, 0.00, 408521997.00, '2026-06-21 20:56:34', '2026-06-21 20:56:34'),
(61, '2026-06-22', 'PAY-13-035635176', 1, 'Pemasukan', 'auto', 'Rental Honda Brio - AA 5678 YY', 3600000.00, 0.00, 412121997.00, '2026-06-21 20:56:35', '2026-06-21 20:56:35'),
(62, '2026-06-22', 'PAY-13-035654610', 1, 'Pemasukan', 'auto', 'Rental Honda Brio - AA 5678 YY', 3600000.00, 0.00, 415721997.00, '2026-06-21 20:56:54', '2026-06-21 20:56:54'),
(63, '2026-06-22', 'PAY-13-035657305', 1, 'Pemasukan', 'auto', 'Rental Honda Brio - AA 5678 YY', 3600000.00, 0.00, 419321997.00, '2026-06-21 20:56:57', '2026-06-21 20:56:57'),
(64, '2026-06-22', 'PAY-13-035659390', 1, 'Pemasukan', 'auto', 'Rental Honda Brio - AA 5678 YY', 3600000.00, 0.00, 422921997.00, '2026-06-21 20:56:59', '2026-06-21 20:56:59'),
(65, '2026-06-22', 'PAY-13-035703788', 1, 'Pemasukan', 'auto', 'Rental Honda Brio - AA 5678 YY', 3600000.00, 0.00, 426521997.00, '2026-06-21 20:57:03', '2026-06-21 20:57:03'),
(66, '2026-06-22', 'PAY-12-040149978', 1, 'Pemasukan', 'auto', 'Rental Toyota Avanza - AA 1234 ZX', 3500000.00, 0.00, 430021997.00, '2026-06-21 21:01:49', '2026-06-21 21:01:49'),
(67, '2026-06-22', 'PAY-14-040429433', 1, 'Pemasukan', 'auto', 'Rental Toyota Avanza - AA 1234 ZX', 126000000.00, 0.00, 556021997.00, '2026-06-21 21:04:29', '2026-06-21 21:04:29');
...
(9, 2, 'KIR-2026-001', '2026-08-20', 20000.00, 'kir/dokumen/1781967463_data-rental (9).pdf', '2026-06-13 12:44:31', '2026-06-20 07:57:43');
...
(6, 'fadddd', '087878901234', 'toty1212121212', '2026-06-21 19:56:26', '2026-06-21 19:56:26');
...
(42, '2026_06_20_171211_create_stnks_table', 6),
(43, '2026_06_20_171505_create_stnk_history_table', 7),
(44, '2026_06_20_171514_create_stnk_table', 8),
(45, '2026_06_20_185146_create_stnk_history_table', 9),
(46, '2026_06_21_164805_create_invoices_table', 10),
(47, '2026_06_21_183354_create_penawaran_kendaraan_table', 11),
(48, '2026_06_21_183433_create_detail_unit_kendaraan_table', 11),
(49, '2026_06_21_193450_add_biaya_per_tahun_kelayakan_invoice_to_rentals_table', 12),
(50, '2026_06_21_194202_add_durasi_tahun_kelayakan_invoice_to_rentals_table', 13);
...
(7, 3, 'Pajak toty22', 10000.00, '2026-10-29', '2026-06-20', 'sudah_bayar', 'haii2222234', 'pajak/bukti/1781967350_6a36a9f6ebcf9.sql', '2026-06-13 12:20:12', '2026-06-20 07:55:50');
...
--
-- Struktur dari tabel `penawaran_kendaraans`
--

CREATE TABLE `penawaran_kendaraans` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `periode` varchar(255) NOT NULL,
  `periode_date` date NOT NULL,
  `tujuan_penawaran` varchar(255) NOT NULL,
  `pic_nama` varchar(255) NOT NULL,
  `pic_telepon` varchar(255) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data untuk tabel `penawaran_kendaraans`
--

INSERT INTO `penawaran_kendaraans` (`id`, `periode`, `periode_date`, `tujuan_penawaran`, `pic_nama`, `pic_telepon`, `created_at`, `updated_at`) VALUES
(1, '2025-01-31', '2026-06-22', 'Kementrian agama', 'bpk tjahyo', '085876047371', '2026-06-21 12:04:57', '2026-06-21 12:04:57');
...
CREATE TABLE `rentals` (
  ...
  `durasi_tahun` bigint(20) NOT NULL DEFAULT 0,
...
INSERT INTO `rentals` (`id`, `user_id`, `kendaraan_id`, `member_id`, `tanggal_mulai`, `tanggal_selesai`, `durasi_jam`, `durasi_hari`, `durasi_bulan`, `biaya_dasar`, `biaya_tambahan_total`, `total_biaya`, `metode_pembayaran`, `jenis_pembayaran`, `nominal_dp`, `bukti_lunas`, `bukti_dp`, `bukti_pelunasan`, `status_pembayaran`, `status`, `created_at`, `updated_at`, `pakai_batas_biaya`, `batas_biaya`, `durasi_tahun`, `invoice`, `kelayakan`) VALUES
(8, 1, 1, 5, '2026-07-01 12:00:00', '2026-09-01 12:00:00', NULL, NULL, 2, 21000000, 0, 21000000, 'tunai', 'dp', 10000000, NULL, '1781374106_dp_logo (1).png', NULL, 'lunas', 'booking', '2026-06-13 11:08:26', '2026-06-21 20:59:30', 0, NULL, 0, NULL, NULL),
(12, 1, 1, 5, '2026-06-15 12:00:00', '2026-06-25 12:00:00', NULL, 10, NULL, 3500000, 0, 3500000, 'tunai', 'lunas', 0, 'uploads/pembayaran/1781458576_lunas_pngtree-creative-boys-avatar-png-image_12850267.png', NULL, NULL, 'lunas', 'aktif', '2026-06-14 10:20:36', '2026-06-21 21:07:47', 0, NULL, 0, NULL, NULL),
(13, 1, 2, 5, '2026-06-15 12:00:00', '2026-06-27 12:00:00', NULL, 12, NULL, 3600000, 0, 3600000, 'tunai', 'lunas', 0, 'uploads/pembayaran/1781457955_lunas_download (2).jpg', NULL, NULL, 'belum_bayar', 'selesai', '2026-06-14 10:25:55', '2026-06-21 20:56:54', 0, NULL, 0, NULL, NULL),
(14, 1, 1, 5, '2027-08-01 12:00:00', '2028-08-01 12:00:00', NULL, NULL, NULL, 126000000, 0, 126000000, 'tunai', 'lunas', 0, 'uploads/pembayaran/1782072114_lunas_moodle.png', NULL, NULL, 'belum_bayar', 'selesai', '2026-06-21 13:01:54', '2026-06-21 21:04:29', 0, NULL, 1, 'uploads/dokumen/1782072114_invoice_opencart.png', 'uploads/dokumen/1782072114_kelayakan_opencart.png'),
(15, 1, 2, 6, '2026-07-01 12:00:00', '2028-07-01 12:00:00', NULL, NULL, NULL, 216000000, 0, 216000000, 'tunai', 'lunas', 0, 'uploads/pembayaran/1782096986_lunas_b0cc7cb2-5af9-4898-930c-96aa9c3dbfbf.jpg', NULL, NULL, 'belum_bayar', 'batal', '2026-06-21 19:56:26', '2026-06-21 20:47:28', 0, NULL, 2, NULL, 'uploads/dokumen/1782096986_kelayakan_moodle.png');
...
(5, 2, '2026-06-14', 2000, 'Layak', 100000, 'oli', 'service-detail/1781967435_data-rental (4).pdf', '2026-06-13 12:50:04', '2026-06-20 07:57:15');
...
(11, 2, '2222', 123, 2, 'selesai', 'bukti_pembayaran/1781967415_Contoh Invoice.pdf', 6, 1200003, 'stabil', '2026-06-14', '2026-06-14 09:32:11', '2026-06-20 07:56:55', 3);
...
('BzYzMedm1r5pEPzh3YnQ7tqPLzpARoFRb1TXBEI6', 1, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/149.0.0.0 Safari/537.36', '', 1782105226);
...
INSERT INTO `stnk` (`id`, `kendaraan_id`, `nopol`, `merk`, `nama_pemilik`, `jenis_model`, `masa_berlaku`, `biaya`, `bukti`, `created_at`, `updated_at`) VALUES
(2, 1, 'AA 1234 ZX', 'Toyota Avanza', 'Budi Santoso', 'Bmw', '2026-08-02', 10000.00, 'stnk/bukti/1782056893_6a3807bd07cde.pdf', '2026-06-21 08:45:20', '2026-06-21 08:48:13');
...
--
-- Dumping data untuk tabel `stnk_histories`
--

INSERT INTO `stnk_histories` (`id`, `stnk_id`, `kendaraan_id`, `nopol`, `merk`, `nama_pemilik`, `jenis_model`, `masa_berlaku`, `biaya`, `bukti`, `diperpanjang_pada`, `created_at`, `updated_at`) VALUES
(2, 2, 1, 'AA 1234 ZX', 'Toyota Avanza', 'Budi Santoso', 'Bmw', '2026-06-21', 10000.00, 'stnk/bukti/1782056893_6a3807bd07cde.pdf', '2026-06-21 08:48:13', '2026-06-21 08:48:13', '2026-06-21 08:48:13');
...
(3, 'VA-2026-00003', 2, '10000', 'virtual-account/bukti/1781967599_data-rental (7).pdf', 'BCA', 10000.00, 10000.00, 'pending', '2026-06-13 16:03:08', '2026-06-20 07:59:59');
...
--
-- Indeks untuk tabel `detail_unit_kendaraans`
--
ALTER TABLE `detail_unit_kendaraans`
  ADD PRIMARY KEY (`id`),
  ADD KEY `detail_unit_kendaraans_penawaran_kendaraan_id_foreign` (`penawaran_kendaraan_id`);
...
--
-- Indeks untuk tabel `penawaran_kendaraans`
--
ALTER TABLE `penawaran_kendaraans`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT untuk tabel `detail_unit_kendaraans`
--
ALTER TABLE `detail_unit_kendaraans`
...
--
-- AUTO_INCREMENT untuk tabel `penawaran_kendaraans`
--
ALTER TABLE `penawaran_kendaraans`
...
--
-- Ketidakleluasaan untuk tabel `detail_unit_kendaraans`
--
ALTER TABLE `detail_unit_kendaraans`
  ADD CONSTRAINT `detail_unit_kendaraans_penawaran_kendaraan_id_foreign` FOREIGN KEY (`penawaran_kendaraan_id`) REFERENCES `penawaran_kendaraans` (`id`) ON DELETE CASCADE;
