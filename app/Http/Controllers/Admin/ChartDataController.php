        ...
        return [
            ...
            'bar' => [
                ...
                'valueColumns' => [
                    ...
                    ['where' => ['status' => ['Disetujui', 'Disetujui Sebagian']],           'column' => 'nominal', 'aggregation' => 'sum', 'label' => 'Disetujui'],
                ...
                'colors'      => ['#6366f1', '#3b82f6', '#f59e0b', '#10b981', '#ef4444'],
                'format'      => 'currency',
            ],
            'line' => [
            ...
            'stats' => [
                ...
                [
                    ...
                    'type'   => 'sum_where',
                    'column' => 'nominal',
                    'where'  => ['status' => ['Disetujui', 'Disetujui Sebagian']],
                    'format' => 'currency',
                    'color'  => '#10b981',
                    'iconBg' => '#d1fae5',
                    'icon'   => 'fa fa-check-circle',
