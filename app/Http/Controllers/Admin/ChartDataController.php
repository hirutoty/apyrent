        ...
        return [
            ...
            'bar' => [
                ...
                'valueColumns' => [
                    ...
                    'paid_amount',
                    'remaining_amount',
                    ['where' => ['payment_status' => 'Paid'],    'column' => 'total_amount', 'aggregation' => 'sum', 'label' => 'Paid'],
                    ['where' => ['payment_status' => 'Partial'],  'column' => 'total_amount', 'aggregation' => 'sum', 'label' => 'Partial'],
                    ['where' => ['payment_status' => 'Unpaid'],   'column' => 'total_amount', 'aggregation' => 'sum', 'label' => 'Unpaid'],
                ],
                'aggregation' => 'sum',
                'dateColumn'  => 'created_at',
                'limit'       => 12,
                'labels'      => ['Total Tagihan', 'Dibayar', 'Sisa Bayar', 'Paid', 'Partial', 'Unpaid'],
                'colors'      => ['#6366f1', '#10b981', '#ef4444', '#059669', '#f59e0b', '#dc2626'],
                'format'      => 'currency',
            ],
            'line' => [
                'title'       => 'Trend Tagihan',
    ...
    protected function getPembayaranConfig(): array
    {
        return [
            ...
            'pie' => [
                ...
                'aggregation' => 'count',
                'labels'      => [],
                'colors'      => ['#3b82f6', '#f59e0b', '#10b981', '#ef4444', '#14b8a6'],
            ],
            'bar' => [
                ...
                'valueColumns' => [
                    'nominal',
                    ['where' => ['status' => 'Diajukan'],                          'column' => 'nominal', 'aggregation' => 'sum', 'label' => 'Diajukan'],
                    ['where' => ['status' => 'Pending'],                           'column' => 'nominal', 'aggregation' => 'sum', 'label' => 'Pending'],
                    ['where' => ['status' => 'Disetujui'],                         'column' => 'nominal', 'aggregation' => 'sum', 'label' => 'Disetujui'],
                    ['where' => ['status' => 'Disetujui Sebagian'],                'column' => 'nominal', 'aggregation' => 'sum', 'label' => 'Sebagian'],
                    ['where' => ['status' => ['Ditolak', 'Disetujui Sebagian']],   'column' => 'nominal', 'aggregation' => 'sum', 'label' => 'Ditolak'],
                ],
                'aggregation' => 'sum',
                'dateColumn'  => 'tanggal',
                'limit'       => 6,
                'labels'      => ['Total', 'Diajukan', 'Pending', 'Disetujui', 'Sebagian Ditolak', 'Ditolak'],
                'colors'      => ['#6366f1', '#3b82f6', '#f59e0b', '#10b981', '#14b8a6', '#ef4444'],
                'format'      => 'currency',
            ],
            'line' => [
            ...
            'stats' => [
                ...
                [
                    ...
                    'type'   => 'sum_where',
                    'column' => 'nominal',
                    'where'  => ['status' => ['Ditolak', 'Disetujui Sebagian']],
                    'format' => 'currency',
                    'color'  => '#ef4444',
                    'iconBg' => '#fee2e2',
                    'icon'   => 'fa fa-times-circle',
    ...
    protected function getPurchaseOrderConfig(): array
    {
        return [
            ...
            'bar' => [
                ...
                'dateColumn'  => 'tanggal_po',
                'limit'       => 6,
                'labels'      => ['Total Diajukan', 'Pending', 'Disetujui', 'Ditolak'],
