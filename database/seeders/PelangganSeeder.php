...
class PelangganSeeder extends Seeder
{
    public function run(): void
    {
        ...
        for ($i = 0; $i < 25; $i++) {
            Pelanggan::create([
                'nama_pelanggan'   => $namaPerorangan[$i],
                'kontak_pelanggan' => '08' . rand(100000000, 999999999),
                'email_pelanggan'  => strtolower(str_replace(' ', '.', $namaPerorangan[$i])) . '@gmail.com',
        ...
        for ($i = 0; $i < 25; $i++) {
            Pelanggan::create([
                'nama_pelanggan'   => $namaPerusahaan[$i],
                'kontak_pelanggan' => '02' . rand(10000000, 99999999),
                'email_pelanggan'  => strtolower(str_replace([' ', '.'], ['', ''], $namaPerusahaan[$i])) . '@mail.co.id',
