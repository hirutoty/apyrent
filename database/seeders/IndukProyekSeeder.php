...
class IndukProyekSeeder extends Seeder
{
    public function run(): void
    {
        IndukProyek::insert([
            ...
            ['kode' => 'PRJ002', 'nama_proyek' => 'Pembayaran Armada Bus Pariwisata',    'jenis' => 'Internal',  'klien_vendor' => '-',              'pic' => 'Rina',  'status' => 'Approved', 'mulai' => '2026-02-01', 'target_selesai' => '2026-04-30', 'progres' => '20%', 'nilai_proyek' => 1500000000, 'lokasi' => 'Jakarta'],
