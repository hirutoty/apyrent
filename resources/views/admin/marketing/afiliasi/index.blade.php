...
<div class="space-y-6">
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        ...
        <div class="flex items-center gap-2">
            <a href="{{ route('afiliasi.pdf') }}" target="_blank" class="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium border border-red-500 text-red-500 rounded-lg bg-transparent hover:bg-red-500 hover:text-white transition-colors">
    ...
    <div class="bg-white rounded-2xl shadow-xl w-full max-w-lg mx-4 max-h-[90vh] overflow-y-auto">
        ...
        <form id="mainForm" action="{{ route('afiliasi.store') }}" method="POST" class="px-6 py-5 space-y-4">
            ...
            <div class="grid grid-cols-2 gap-3">
                ...
                <input type="text" name="id_program" id="f_id_program" required placeholder="AFI001" class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-400" value="{{ old('id_program') }}"</div>
                <div><label class="block text-xs font-semibold text-gray-600 mb-1.5">Kode Referral <span class="text-red-500">*</span></label>
                <input type="text" name="kode_referral" id="f_kode_referral" required placeholder="REF-APY001" class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-400" value="{{ old('kode_referral') }}"</div>
            </div>
            <div><label class="block text-xs font-semibold text-gray-600 mb-1.5">Nama Program <span class="text-red-500">*</span></label>
            <input type="text" name="nama_program" id="f_nama_program" required placeholder="Nama program afiliasi" class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-400" value="{{ old('nama_program') }}"</div>
            <div class="grid grid-cols-2 gap-3">
                <div><label class="block text-xs font-semibold text-gray-600 mb-1.5">Diskon Referral (Rp) <span class="text-red-500">*</span></label>
                <input type="number" name="diskon_referral" id="f_diskon_referral" required min="0" max="9999999999" placeholder="50000" class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-400" value="{{ old('diskon_referral') }}"</div>
                <div><label class="block text-xs font-semibold text-gray-600 mb-1.5">Bonus Pengajak <span class="text-red-500">*</span></label>
                <input type="number" name="bonus_pengajak" id="f_bonus_pengajak" required min="0" placeholder="75000" class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-400" value="{{ old('bonus_pengajak') }}"</div>
            </div>
            <div class="grid grid-cols-2 gap-3">
                <div><label class="block text-xs font-semibold text-gray-600 mb-1.5">Batas Waktu <span class="text-red-500">*</span></label>
                <input type="date" name="batas_waktu" id="f_batas_waktu" required class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-400" value="{{ old('batas_waktu') }}"</div>
