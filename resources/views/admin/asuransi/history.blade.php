...
<div class="bg-white rounded-xl shadow-sm border border-gray-200">
    ...
    <div class="flex flex-col gap-4 p-6 border-b">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-xl font-bold text-gray-800">History Perpanjangan Asuransi</h1>
                <p class="text-sm text-gray-500 mt-1">Riwayat seluruh data asuransi kendaraan yang telah diperpanjang.</p>
            </div>
            <div class="w-80">
                <input type="text" id="search" placeholder="Cari kendaraan, asuransi..."
        ...
        <form method="GET" action="{{ route('history.asuransi.index') }}" class="flex flex-wrap items-center gap-3">
