...
<head>
    <meta charset="utf-8">
    <title>Laporan STNK Kendaraan</title>
...
<body>
            ...
            <tr>
                ...
                <td width="30%">
                    <div class="report-title">
                        <h1>STNK KENDARAAN</h1>
                        <p>Laporan History Perpanjangan STNK</p>
                    </div>
                </td>
        ...
        <table class="main-table">
            ...
            <thead>
                <tr>
                    ...
                    <th width="13%">Masa Berlaku Lama</th>
            ...
            <tbody>
                ...
                <tr class="row-subtotal">
                    ...
                    <td class="text-center">
                        {{ $data->filter(fn($item) => !empty($item->bukti))->count() }}
                    </td>
                </tr>
    ...
    <div class="note-box">
        ...
        <p>
            Laporan ini merupakan data riwayat perpanjangan STNK kendaraan yang terdaftar pada sistem
            {{ $setting?->nama_perusahaan }}.
            Data mencakup informasi kendaraan, pemilik, biaya perpanjangan, masa berlaku sebelumnya,
            tanggal perpanjangan dilakukan, serta ketersediaan bukti pembayaran.
        </p>
