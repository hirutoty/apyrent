...
<body class="bg-gray-100">
                ...
                <tbody>
                    @foreach ($data as $d)
                        <tr class="border-b">
                            ...
                            <td class="p-2">{{ $d->member->nama_pelanggan ?? '-' }}</td>
                            ...
                            <td class="p-2 space-x-2">
                                ...
                                <form action="/admin/member-rental/{{ $d->id }}" method="POST"
                                    class="inline">
                                    @csrf @method('DELETE')
    ...
    <div id="modal" class="hidden fixed inset-0 bg-black/50 flex items-center justify-center">
        ...
        <div class="bg-white p-6 rounded w-96">
            ...
            <form id="form" method="POST" action="/admin/member-rental">
                @csrf
    ...
    btn.addEventListener('click', function() {
        ...
        document.getElementById('form').action =
            '/admin/member-rental/' + this.dataset.id;
