   ...
   Export PDF
                ...
                <div class="relative">
                    ...
                    <input type="text" placeholder="Cari member..."
                        oninput="filterMemberTable(this.value)"
                ...
                <tbody id="memberTableBody">
                    @forelse ($data as $i => $d)
                        <tr class="border-t border-gray-50 hover:bg-gray-50 transition-colors duration-100"
                            ...
                            <td class="px-4 py-3.5">
                                <span class="font-mono text-xs text-gray-600 bg-gray-100 px-2 py-0.5 rounded">{{ $d->kontak_member }}</span>
                            </td>

                            <td class="px-4 py-3.5 text-sm text-gray-500 max-w-[200px] truncate">{{ $d->alamat ?? '-' }}</td>
                            ...
                            <td class="px-4 py-3.5">
                                <div class="flex items-center justify-center gap-1.5">
                                    <button
                                        ...
                                        data-id="{{ $d->id }}"
                                        data-nama_member="{{ $d->nama_member }}"
                        ...
                        <tr>
                            <td colspan="5" class="px-5 py-12 text-center">
                                <div class="flex flex-col items-center gap-3">
                                    ...
                                    <p class="text-xs text-gray-400">Klik "Tambah Member" untuk menambahkan data baru</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
...
<div id="memberModal"
    ...
    <div class="bg-white rounded-2xl shadow-xl w-full max-w-md mx-4"
        ...
        <form id="memberForm" action="/admin/member" method="POST" class="px-6 py-5 space-y-4">
            ...
            <div>
                <label class="block text-xs font-semibold text-gray-600 mb-1.5">Nama Member <span class="text-red-500">*</span></label>
                <input type="text" name="nama_member" id="f_nama_member" required
                    placeholder="Contoh: Budi Santoso"
                    class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-400">
            </div>

            <div>
                <label class="block text-xs font-semibold text-gray-600 mb-1.5">Kontak <span class="text-red-500">*</span></label>
                <input type="text" name="kontak_member" id="f_kontak_member" required
...
function filterMemberTable(q) {
    document.querySelectorAll('#memberTableBody tr[data-search]').forEach(row => {
