...
{{-- <div class="note-box">
    ...
    <div class="note-content">
        Laporan ini merupakan daftar data member yang terdaftar pada sistem
        {{ $setting?->nama_perusahaan }}. Informasi yang ditampilkan meliputi
        nama member, kontak yang dapat dihubungi, dan alamat member sebagai
        data referensi pelanggan perusahaan.
    </div>
