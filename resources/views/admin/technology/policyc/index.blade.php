    ...
    <div class="bg-white rounded-2xl shadow-xl w-full max-w-xl mx-4 max-h-[90vh] overflow-y-auto" style="animation:slideUp .2s ease">
        ...
        <form id="mainForm" action="{{ route('policyc.store') }}" method="POST" class="px-6 py-5 space-y-4">
            ...
            <div><label class="block text-xs font-semibold text-gray-600 mb-1.5">Nama Dokumen <span class="text-red-500">*</span></label>
                <input type="text" name="nama_dokumen" id="f_nama_dokumen" required placeholder="Kebijakan Keamanan Informasi" class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-400"></div>
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div><label class="block text-xs font-semibold text-gray-600 mb-1.5">Versi <span class="text-red-500">*</span></label>
                    <input type="text" name="versi" id="f_versi" required placeholder="v1.0" class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm font-mono focus:outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-400"></div>
