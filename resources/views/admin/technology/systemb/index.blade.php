        ...
        <form id="mainForm" action="{{ route('systemb.store') }}" method="POST" class="px-6 py-5 space-y-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div><label class="block text-xs font-semibold text-gray-600 mb-1.5">Sistem <span class="text-red-500">*</span></label>
                    <input type="text" name="sistem" id="f_sistem" required placeholder="Database / Aplikasi / File Server" class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-400"></div>
                <div><label class="block text-xs font-semibold text-gray-600 mb-1.5">Metode Backup <span class="text-red-500">*</span></label>
                    <input type="text" name="metode_backup" id="f_metode_backup" required placeholder="Full / Incremental / Differential" class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-400"></div>
            </div>
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div><label class="block text-xs font-semibold text-gray-600 mb-1.5">Frekuensi <span class="text-red-500">*</span></label>
                    <input type="text" name="frekuensi" id="f_frekuensi" required placeholder="Harian / Mingguan / Bulanan" class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-400"></div>
                <div><label class="block text-xs font-semibold text-gray-600 mb-1.5">Lokasi Backup <span class="text-red-500">*</span></label>
                    <input type="text" name="lokasi_backup" id="f_lokasi_backup" required placeholder="NAS / Cloud / Tape" class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-400"></div>
            </div>
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div><label class="block text-xs font-semibold text-gray-600 mb-1.5">Status Backup <span class="text-red-500">*</span></label>
                    <input type="text" name="status_backup" id="f_status_backup" required placeholder="Aktif / Nonaktif / Gagal" class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-400"></div>
                <div><label class="block text-xs font-semibold text-gray-600 mb-1.5">Uji Restore Terakhir</label>
                    <input type="date" name="uji_restore_terakhir" id="f_uji_restore_terakhir" class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-400"></div>
            </div>
