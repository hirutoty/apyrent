...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 px-5 py-4 border-b border-gray-100">
            <div><h2 class="font-semibold text-gray-800 text-base">Daftar Shift & Lembur</h2><p class="text-xs text-gray-400 mt-0.5">{{ $data->total() }} total data</p></div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                    ...
                    <input type="number" name="jam_lembur" id="f_jam_lembur" min="0" step="0.5" placeholder="2"
                        class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-400" value="{{ old('jam_lembur') }}"
                </div>
                <div>
                    ...
                    <input type="number" name="total_jam" id="f_total_jam" required min="0" step="0.5" placeholder="8"
                        class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-400" value="{{ old('total_jam') }}"
                </div>
            </div>
            <div>
                <label class="block text-xs font-semibold text-gray-600 mb-1.5">Keterangan <span class="text-red-500">*</span></label>
                <textarea name="keterangan" id="f_keterangan" rows="2" placeholder="Catatan shift / lembur..."
