            ...
            <tr>
                ...
                <td width="30%">
                    <div class="report-title">
                        <h1>BUPOT</h1>
                        <p>Laporan Bukti Potong Pajak</p>
                    </div>
                </td>
        ...
        <table class="main-table">
            ...
            <thead>
                <tr>
                    ...
                    <th width="10%">Tipe</th>
                    <th width="14%">Pemotong</th>
                    <th width="14%">Dipotong</th>
            ...
            <tbody>
                ...
                @php
                    $totalBruto = $data->sum('jumlah_bruto');
                    $totalPotong = $data->sum('jumlah_potong');
                @endphp
                ...
                @foreach ($data as $i => $item)
                    <tr>
                        ...
                        <td class="text-center">
                            {{ \Carbon\Carbon::parse($item->tanggal_bukti)->format('d-m-Y') }}
                        </td>
                        ...
                        <td class="text-right">
                            Rp {{ number_format($item->jumlah_bruto, 0, ',', '.') }}
                        </td>

                        <td class="text-center">
                            {{ number_format($item->tarif_pajak, 0) }}%
                        </td>
                ...
                <tr class="row-subtotal">
                    ...
                    <td class="text-right">
                        Rp {{ number_format($totalPotong, 0, ',', '.') }}
                    </td>
