        ...
        <form id="mainForm" action="{{ route('asset.pemeliharaan.store') }}" method="POST" class="px-6 py-5 space-y-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <div><label class="block text-xs font-semibold text-gray-600 mb-1.5">Biaya (Rp) <span class="text-red-500">*</span></label>
                    <input type="number" max="9999999999" min="0" step="0.01" name="biaya" id="f_biaya" required class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-400" value="{{ old('biaya') }}"></div>
