        ...
        <form id="mainForm" action="{{ route('asset.dokumentasi.store') }}" method="POST" class="px-6 py-5 space-y-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div><label class="block text-xs font-semibold text-gray-600 mb-1.5">Lokasi File</label>
                    <input type="text" name="lokasi_file" id="f_lokasi_file" placeholder="/storage/assets/foto.jpg" class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-400"></div>
            </div>
