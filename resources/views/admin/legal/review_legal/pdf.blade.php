...
<body>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $d->pic_legal }}</td>
                <td>
                    <span class="badge {{ $d->status_review === 'Selesai' ? 'badge-green' : ($d->status_review === 'Proses' ? 'badge-yellow' : 'badge-gray') }}">
                        {{ $d->status_review }}
                    </span>
                </td>
                <td>{{ $d->catatan ?? '-' }}</td>
    ...
    <div class="footer">{{ $setting?->nama_perusahaan ?? 'APY Rent' }} &mdash; Laporan Review Legal</div>
</body>
</html>
